...
func NewCoreService(opts ServiceOptions) func(*core.Core) core.Result {
	return func(c *core.Core) core.Result {
		...
		if opts.Language != "" {
			if r := svc.SetLanguage(opts.Language); !r.OK {
				return r
			}
		}
		if opts.Fallback != "" {
...
func (s *CoreService) SetLanguage(lang string) core.Result {
	if svc := s.wrapped(); svc != nil {
...
func (s *CoreService) AddLoader(loader Loader) core.Result {
	if svc := s.wrapped(); svc != nil {
...
func (s *CoreService) LoadFS(fsys fs.FS, dir string) core.Result {
	if svc := s.wrapped(); svc != nil {
