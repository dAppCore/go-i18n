...
func (messageBaseFallbackLoader) Load(lang string) core.Result {
	return localeLoadResult(map[string]Message{}, nil)
}
...
func (underscoreLangLoader) Load(lang string) core.Result {
	return localeLoadResult(map[string]Message{
		"greeting": {Text: "hello"},
	}, nil)
}
...
func (duplicateLangLoader) Load(lang string) core.Result {
	switch lang {
	case "en_US":
		return localeLoadResult(map[string]Message{
...
func (intentReceiverLanguageLoader) Load(lang string) core.Result {
...
func TestNewServiceAliases(t *testing.T) {
	svc, err := serviceFromResult(NewService())
	if err != nil {
	...
	withFS, err := serviceFromResult(NewServiceWithFS(fsys, "locales"))
	if err != nil {
	...
	withLoader, err := serviceFromResult(NewServiceWithLoader(messageBaseFallbackLoader{}))
	if err != nil {
...
func TestServiceNilReceiverIsSafe(t *testing.T) {
	...
	if err := errorFromResult(svc.SetLanguage("en")); err != ErrServiceNotInitialised {
		t.Fatalf("nil Service.SetLanguage() error = %v, want ErrServiceNotInitialised", err)
	}
	if err := errorFromResult(svc.AddLoader(nil)); err != ErrServiceNotInitialised {
		t.Fatalf("nil Service.AddLoader() error = %v, want ErrServiceNotInitialised", err)
	}
	if err := errorFromResult(svc.LoadFS(fstest.MapFS{}, "locales")); err != ErrServiceNotInitialised {
...
func TestServiceSetLanguageUnsupportedIncludesAvailableLanguages(t *testing.T) {
	...
	err = errorFromResult(svc.SetLanguage("es"))
	if err == nil {
...
func TestNewWithHandlersCopiesInputSlice(t *testing.T) {
	...
	svc, err := serviceFromResult(New(WithHandlers(handlers...)))
	if err != nil {
		t.Fatalf("New() failed: %v", err)
	}
...
func TestNewWithLoaderNormalisesLanguageTags(t *testing.T) {
	svc, err := serviceFromResult(NewWithLoader(underscoreLangLoader{}))
	if err != nil {
		t.Fatalf("NewWithLoader() failed: %v", err)
	}
	...
	if err := errorFromResult(svc.SetLanguage("en_US")); err != nil {
...
func TestNewWithLoaderMergesCanonicalDuplicateLanguages(t *testing.T) {
	svc, err := serviceFromResult(NewWithLoader(duplicateLangLoader{}))
	if err != nil {
		t.Fatalf("NewWithLoader() failed: %v", err)
	}

	if err := errorFromResult(svc.SetLanguage("en-US")); err != nil {
...
func TestServiceFallbackNormalisesLanguageTag(t *testing.T) {
	svc, err := serviceFromResult(New(WithFallback("fr_CA")))
	if err != nil {
		t.Fatalf("New() failed: %v", err)
	}
...
func TestServiceMessageFallbackUsesBaseLanguageTagBeforeConfiguredFallback(t *testing.T) {
	...
	if err := errorFromResult(svc.SetLanguage("en-GB")); err != nil {
...
func TestServiceSubjectCountPlurals(t *testing.T) {
	...
	if err := errorFromResult(svc.loadJSON("en", []byte(`{
		"item_count": {
			"one": "{{.Count}} item",
			"other": "{{.Count}} items"
		}
...
func TestServiceLoadJSONPartialVerbForms(t *testing.T) {
	...
	if err := errorFromResult(svc.loadJSON(lang, []byte(`{
		"gram": {
			"verb": {
...
func TestServiceComposeGeneratedIntentTextUsesReceiverLanguage(t *testing.T) {
	...
	defaultSvc, err := serviceFromResult(New(WithLanguage("en")))
	if err != nil {
		t.Fatalf("New() failed: %v", err)
	}
	SetDefault(defaultSvc)

	svc, err := serviceFromResult(NewWithLoader(intentReceiverLanguageLoader{}, WithFallback("en")))
	if err != nil {
		t.Fatalf("NewWithLoader() failed: %v", err)
	}
	if err := errorFromResult(svc.SetLanguage(lang)); err != nil {
...
func TestServiceAddMessages_RegistersLanguage(t *testing.T) {
	...
	if err := errorFromResult(svc.SetLanguage("fr_CA")); err != nil {
...
func TestWithDefaultHandlers_Idempotent(t *testing.T) {
	svc, err := serviceFromResult(New(WithDefaultHandlers()))
	if err != nil {
...
func TestWithLanguage(t *testing.T) {
	svc, err := serviceFromResult(New(WithLanguage("fr_CA")))
	if err != nil {
...
func TestNewWithFS(t *testing.T) {
	...
	svc, err := serviceFromResult(NewWithFS(fs, "i18n", WithFallback("custom")))
	if err != nil {
...
func TestServiceAddLoader_Good(t *testing.T) {
	...
	if err := errorFromResult(svc.AddLoader(NewFSLoader(extra, "."))); err != nil {
...
func TestServiceAddLoader_Bad(t *testing.T) {
	...
	if err := errorFromResult(svc.AddLoader(NewFSLoader(broken, "."))); err == nil {
...
func TestServiceAddLoader_Nil(t *testing.T) {
	...
	if err := errorFromResult(svc.AddLoader(nil)); err == nil {
...
func TestServiceAddLoader_NoLanguages(t *testing.T) {
	...
	empty := fstest.MapFS{}
	if err := errorFromResult(svc.AddLoader(NewFSLoader(empty, "missing"))); err == nil {
...
func TestServiceLoadFS_Good(t *testing.T) {
	...
	if err := errorFromResult(svc.LoadFS(extra, "locales")); err != nil {
...
func TestServiceLoadFS_Bad(t *testing.T) {
	...
	empty := fstest.MapFS{}
	if err := errorFromResult(svc.LoadFS(empty, "nonexistent")); err == nil {
...
func TestNewWithLoaderNoLanguages(t *testing.T) {
	empty := fstest.MapFS{}
	_, err := serviceFromResult(NewWithFS(empty, "empty"))
	if err == nil {
...
func TestNewWithLoaderNil(t *testing.T) {
	if _, err := serviceFromResult(NewWithLoader(nil)); err == nil {
...
func TestService_WithFallback_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithFallback("fr")))
...
func TestService_WithFallback_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithFallback Bad edge case")
		svc, err := serviceFromResult(New(WithFallback("")))
		_ = svc
		_ = err
	})
	if !called {
...
func TestService_WithFallback_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithFallback Ugly edge case")
		svc, err := serviceFromResult(New(WithFallback("fr")))
		if err != nil || svc.Fallback() != "fr" {
			t.Fatalf("fallback=%q err=%v", svc.Fallback(), err)
		}
...
func TestService_WithLanguage_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithLanguage("fr")))
...
func TestService_WithLanguage_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithLanguage Bad edge case")
		svc, err := serviceFromResult(New(WithLanguage("")))
		_ = svc
		_ = err
	})
	if !called {
...
func TestService_WithLanguage_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithLanguage Ugly edge case")
		svc, err := serviceFromResult(New(WithLanguage("fr")))
		if err != nil || svc.Language() == "" {
			t.Fatalf("language=%q err=%v", svc.Language(), err)
		}
...
func TestService_WithFormality_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithFormality(FormalityFormal)))
...
func TestService_WithFormality_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithFormality Bad edge case")
		svc, err := serviceFromResult(New(WithFormality(FormalityFormal)))
		_ = svc
		_ = err
	})
...
func TestService_WithFormality_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithFormality Ugly edge case")
		svc, err := serviceFromResult(New(WithFormality(FormalityFormal)))
		if err != nil || svc.Formality() != FormalityFormal {
			t.Fatalf("formality=%v err=%v", svc.Formality(), err)
		}
...
func TestService_WithLocation_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithLocation("workspace")))
...
func TestService_WithLocation_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithLocation Bad edge case")
		svc, err := serviceFromResult(New(WithLocation("")))
		_ = svc
		_ = err
	})
	if !called {
...
func TestService_WithLocation_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithLocation Ugly edge case")
		svc, err := serviceFromResult(New(WithLocation("workspace")))
		if err != nil || svc.Location() != "workspace" {
			t.Fatalf("location=%q err=%v", svc.Location(), err)
		}
...
func TestService_WithHandlers_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithHandlers(ax7Handler{match: true})))
...
func TestService_WithHandlers_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithHandlers Bad edge case")
		svc, err := serviceFromResult(New(WithHandlers(ax7Handler{match: true})))
		_ = svc
		_ = err
	})
...
func TestService_WithHandlers_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithHandlers Ugly edge case")
		svc, err := serviceFromResult(New(WithHandlers(ax7Handler{match: true})))
		if err != nil || len(svc.Handlers()) != 1 {
			t.Fatalf("handlers=%d err=%v", len(svc.Handlers()), err)
		}
...
func TestService_WithDefaultHandlers_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithHandlers(), WithDefaultHandlers()))
...
func TestService_WithDefaultHandlers_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithDefaultHandlers Bad edge case")
		svc, err := serviceFromResult(New(WithHandlers(), WithDefaultHandlers()))
		_ = svc
		_ = err
	})
...
func TestService_WithDefaultHandlers_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithDefaultHandlers Ugly edge case")
		svc, err := serviceFromResult(New(WithHandlers(), WithDefaultHandlers()))
		if err != nil || len(svc.Handlers()) == 0 {
			t.Fatalf("handlers=%d err=%v", len(svc.Handlers()), err)
		}
...
func TestService_WithMode_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithMode(ModeCollect)))
...
func TestService_WithDebug_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithDebug(true)))
...
func TestService_WithDebug_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("WithDebug Ugly edge case")
		svc, err := serviceFromResult(New(WithDebug(true)))
		if err != nil || !svc.Debug() {
			t.Fatalf("debug=%v err=%v", svc.Debug(), err)
		}
...
func TestService_New_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithLanguage("zz")))
		if err == nil || svc != nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_New_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(New(WithHandlers(nil)))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewService_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewService(WithLanguage("zz")))
		if err == nil || svc != nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewService_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewService(WithHandlers(nil)))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewWithFS_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewWithFS(testLocaleFS(), "locales"))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewWithFS_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewWithFS(testLocaleFS(), "missing"))
		if err == nil || svc != nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewWithFS_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewWithFS(testLocaleFS(), "locales", WithLanguage("fr")))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewServiceWithFS_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewServiceWithFS(testLocaleFS(), "locales"))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewServiceWithFS_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewServiceWithFS(testLocaleFS(), "missing"))
		if err == nil || svc != nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewServiceWithFS_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewServiceWithFS(testLocaleFS(), "locales", WithLanguage("fr")))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewWithLoader_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewWithLoader(NewFSLoader(testLocaleFS(), "locales")))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewWithLoader_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewWithLoader(nil))
		if err == nil || svc != nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewWithLoader_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewWithLoader(NewFSLoader(testLocaleFS(), "locales"), WithLanguage("fr")))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewServiceWithLoader_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewServiceWithLoader(NewFSLoader(testLocaleFS(), "locales")))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewServiceWithLoader_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewServiceWithLoader(nil))
		if err == nil || svc != nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_NewServiceWithLoader_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc, err := serviceFromResult(NewServiceWithLoader(NewFSLoader(testLocaleFS(), "locales"), WithLanguage("fr")))
		if err != nil || svc == nil {
			t.Fatalf("svc=%v err=%v", svc, err)
		}
	})
...
func TestService_AddLoader_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc := setDefaultForAudit(t)
		AddLoader(NewFSLoader(testLocaleFS(), "locales"))
...
func TestService_Service_SetLanguage_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc := serviceForAudit(t)
		err := errorFromResult(svc.SetLanguage("fr"))
		if err != nil {
			t.Fatalf("err=%v", err)
		}
	})
...
func TestService_Service_SetLanguage_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc := serviceForAudit(t)
		err := errorFromResult(svc.SetLanguage("zz"))
		if err == nil {
...
func TestService_Service_CurrentDirection_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_CurrentDirection Bad edge case")
		var svc *Service
		got := svc.CurrentDirection()
		if got != DirLTR {
			t.Fatalf("got %v", got)
...
func TestService_Service_CurrentDirection_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_CurrentDirection Ugly edge case")
		svc := serviceForAudit(t)
		got := svc.CurrentDirection()
		if got != DirLTR {
			t.Fatalf("got %v", got)
...
func TestService_Service_CurrentTextDirection_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_CurrentTextDirection Bad edge case")
		var svc *Service
		got := svc.CurrentTextDirection()
		if got != DirLTR {
			t.Fatalf("got %v", got)
...
func TestService_Service_CurrentTextDirection_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_CurrentTextDirection Ugly edge case")
		svc := serviceForAudit(t)
		got := svc.CurrentTextDirection()
		if got != DirLTR {
			t.Fatalf("got %v", got)
...
func TestService_Service_IsRTL_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_IsRTL Bad edge case")
		var svc *Service
		got := svc.IsRTL()
		if got {
			t.Fatal("expected ltr")
...
func TestService_Service_IsRTL_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_IsRTL Ugly edge case")
		svc := serviceForAudit(t)
		got := svc.IsRTL()
		if got {
			t.Fatal("expected ltr")
...
func TestService_Service_CurrentIsRTL_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_CurrentIsRTL Bad edge case")
		var svc *Service
		got := svc.CurrentIsRTL()
		if got {
			t.Fatal("expected ltr")
...
func TestService_Service_CurrentIsRTL_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_CurrentIsRTL Ugly edge case")
		svc := serviceForAudit(t)
		got := svc.CurrentIsRTL()
		if got {
			t.Fatal("expected ltr")
...
func TestService_Service_RTL_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_RTL Bad edge case")
		var svc *Service
		got := svc.RTL()
		if got {
			t.Fatal("expected ltr")
...
func TestService_Service_RTL_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_RTL Ugly edge case")
		svc := serviceForAudit(t)
		got := svc.RTL()
		if got {
			t.Fatal("expected ltr")
...
func TestService_Service_CurrentRTL_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_CurrentRTL Bad edge case")
		var svc *Service
		got := svc.CurrentRTL()
		if got {
			t.Fatal("expected ltr")
...
func TestService_Service_CurrentRTL_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("Service_CurrentRTL Ugly edge case")
		svc := serviceForAudit(t)
		got := svc.CurrentRTL()
		if got {
			t.Fatal("expected ltr")
...
func TestService_Service_AddLoader_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc := serviceForAudit(t)
		err := errorFromResult(svc.AddLoader(NewFSLoader(testLocaleFS(), "locales")))
		if err != nil {
			t.Fatalf("err=%v", err)
		}
	})
...
func TestService_Service_AddLoader_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc := serviceForAudit(t)
		err := errorFromResult(svc.AddLoader(nil))
		if err == nil {
			t.Fatal("expected error")
		}
	})
...
func TestService_Service_LoadFS_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc := serviceForAudit(t)
		err := errorFromResult(svc.LoadFS(testLocaleFS(), "locales"))
		if err != nil {
			t.Fatalf("err=%v", err)
		}
	})
...
func TestService_Service_LoadFS_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		svc := serviceForAudit(t)
		err := errorFromResult(svc.LoadFS(testLocaleFS(), "missing"))
		if err == nil {
			t.Fatal("expected error")
		}
	})
