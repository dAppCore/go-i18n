...
func TestCoreServiceNilSafe(t *testing.T) {
	...
	if err := errorFromResult(svc.SetLanguage("fr")); !core.Is(err, ErrServiceNotInitialised) {
		t.Fatalf("expected error %v, got %v", ErrServiceNotInitialised, err)
	}
	if err := errorFromResult(svc.AddLoader(nil)); !core.Is(err, ErrServiceNotInitialised) {
		t.Fatalf("expected error %v, got %v", ErrServiceNotInitialised, err)
	}
	if err := errorFromResult(svc.LoadFS(nil, "locales")); !core.Is(err, ErrServiceNotInitialised) {
		t.Fatalf("expected error %v, got %v", ErrServiceNotInitialised, err)
	}
}
...
func TestCoreService_FSSource_String_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		src := FSSource{FS: testLocaleFS(), Dir: "locales"}
		got := src.String()
		if got == "" {
...
func TestCoreService_ServiceOptions_String_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		opts := ServiceOptions{Language: "en", ExtraFS: []FSSource{{FS: testLocaleFS(), Dir: "locales"}}}
		got := opts.String()
		if got == "" {
			t.Fatal("expected string")
		}
...
func TestCoreService_NewCoreService_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		...
		got, err := valueFromResult[any](factory(nil))
		if err != nil || got == nil {
...
func TestCoreService_NewCoreService_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		factory := NewCoreService(ServiceOptions{ExtraFS: []FSSource{{FS: testLocaleFS(), Dir: "locales"}}})
		got, err := valueFromResult[any](factory(nil))
		if err != nil || got == nil {
			t.Fatalf("got=%v err=%v", got, err)
		}
...
func TestCoreService_CoreService_OnShutdown_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_OnShutdown Bad edge case")
		var svc *CoreService
		r := svc.OnShutdown(nil)
		if !r.OK {
			t.Fatalf("got %v", r)
...
func TestCoreService_CoreService_OnShutdown_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_OnShutdown Ugly edge case")
		svc := coreServiceForAudit(t)
		r := svc.OnShutdown(nil)
		if !r.OK {
			t.Fatalf("got %v", r)
...
func TestCoreService_CoreService_Mode_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Mode Bad edge case")
		var svc *CoreService
		got := svc.Mode()
		if got != ModeNormal {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_Mode_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Mode Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.Mode()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentMode_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentMode Bad edge case")
		var svc *CoreService
		got := svc.CurrentMode()
		if got != ModeNormal {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentMode_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentMode Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentMode()
		_ = got
	})
...
func TestCoreService_CoreService_Language_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Language Bad edge case")
		var svc *CoreService
		got := svc.Language()
		if got != "en" {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_Language_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Language Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.Language()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentLanguage_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentLanguage Bad edge case")
		var svc *CoreService
		got := svc.CurrentLanguage()
		if got != "en" {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentLanguage_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentLanguage Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentLanguage()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentLang_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentLang Bad edge case")
		var svc *CoreService
		got := svc.CurrentLang()
		if got != "en" {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentLang_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentLang Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentLang()
		_ = got
	})
...
func TestCoreService_CoreService_Fallback_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Fallback Bad edge case")
		var svc *CoreService
		got := svc.Fallback()
		if got != "en" {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_Fallback_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Fallback Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.Fallback()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentFallback_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentFallback Bad edge case")
		var svc *CoreService
		got := svc.CurrentFallback()
		if got != "en" {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentFallback_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentFallback Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentFallback()
		_ = got
	})
...
func TestCoreService_CoreService_Formality_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Formality Bad edge case")
		var svc *CoreService
		got := svc.Formality()
...
func TestCoreService_CoreService_Formality_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Formality Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.Formality()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentFormality_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentFormality Bad edge case")
		var svc *CoreService
		got := svc.CurrentFormality()
		if got != FormalityNeutral {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentFormality_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentFormality Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentFormality()
		_ = got
	})
...
func TestCoreService_CoreService_Location_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Location Bad edge case")
		var svc *CoreService
		got := svc.Location()
		if got != "" {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_Location_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Location Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.Location()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentLocation_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentLocation Bad edge case")
		var svc *CoreService
		got := svc.CurrentLocation()
		if got != "" {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentLocation_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentLocation Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentLocation()
		_ = got
	})
...
func TestCoreService_CoreService_Debug_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Debug Bad edge case")
		var svc *CoreService
		got := svc.Debug()
		if got != false {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_Debug_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Debug Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.Debug()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentDebug_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentDebug Bad edge case")
		var svc *CoreService
		got := svc.CurrentDebug()
		if got != false {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentDebug_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentDebug Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentDebug()
		_ = got
	})
...
func TestCoreService_CoreService_Direction_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Direction Bad edge case")
		var svc *CoreService
		got := svc.Direction()
		if got != DirLTR {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_Direction_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_Direction Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.Direction()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentDirection_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentDirection Bad edge case")
		var svc *CoreService
		got := svc.CurrentDirection()
		if got != DirLTR {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentDirection_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentDirection Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentDirection()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentTextDirection_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentTextDirection Bad edge case")
		var svc *CoreService
		got := svc.CurrentTextDirection()
		if got != DirLTR {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentTextDirection_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentTextDirection Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentTextDirection()
		_ = got
	})
...
func TestCoreService_CoreService_IsRTL_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_IsRTL Bad edge case")
		var svc *CoreService
		got := svc.IsRTL()
		if got != false {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_IsRTL_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_IsRTL Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.IsRTL()
		_ = got
	})
...
func TestCoreService_CoreService_RTL_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_RTL Bad edge case")
		var svc *CoreService
		got := svc.RTL()
		if got != false {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_RTL_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_RTL Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.RTL()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentIsRTL_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentIsRTL Bad edge case")
		var svc *CoreService
		got := svc.CurrentIsRTL()
		if got != false {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentIsRTL_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentIsRTL Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentIsRTL()
		_ = got
	})
...
func TestCoreService_CoreService_CurrentRTL_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentRTL Bad edge case")
		var svc *CoreService
		got := svc.CurrentRTL()
		if got != false {
			t.Fatalf("got %v", got)
...
func TestCoreService_CoreService_CurrentRTL_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("CoreService_CurrentRTL Ugly edge case")
		svc := coreServiceForAudit(t)
		got := svc.CurrentRTL()
		_ = got
	})
