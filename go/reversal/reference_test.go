...
func TestBuildReferences_Empty(t *testing.T) {
	tok := initI18n(t)
	_, err := valueFromResult[*ReferenceSet](BuildReferences(tok, nil))
	if err == nil {
...
func TestBuildReferences_NoDomainLabels(t *testing.T) {
	...
	_, err := valueFromResult[*ReferenceSet](BuildReferences(tok, samples))
	if err == nil {
...
func TestReferenceSet_DomainNames(t *testing.T) {
	...
	rs, _ := valueFromResult[*ReferenceSet](BuildReferences(tok, samples))
...
func TestReference_BuildReferences_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		tok := initI18n(t)
		rs, err := valueFromResult[*ReferenceSet](BuildReferences(tok, nil))
		if err == nil || rs != nil {
			t.Fatalf("rs=%v err=%v", rs, err)
		}
	})
...
func TestReference_BuildReferences_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		tok := initI18n(t)
		rs, err := valueFromResult[*ReferenceSet](BuildReferences(tok, []ClassifiedText{{Text: "No domain"}}))
		if err == nil || rs != nil {
			t.Fatalf("rs=%v err=%v", rs, err)
		}
	})
...
func TestReference_ReferenceSet_Compare_Good(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		tok := initI18n(t)
		rs, _ := valueFromResult[*ReferenceSet](BuildReferences(tok, []ClassifiedText{{Text: "Delete files", Domain: "technical"}}))
...
func TestReference_ReferenceSet_Compare_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("ReferenceSet_Compare Bad edge case")
		tok := initI18n(t)
		rs, _ := valueFromResult[*ReferenceSet](BuildReferences(tok, []ClassifiedText{{Text: "Delete files", Domain: "technical"}}))
		got := rs.Compare(NewImprint(tok.Tokenise("Delete files")))
		if len(got) == 0 {
...
func TestReference_ReferenceSet_Compare_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("ReferenceSet_Compare Ugly edge case")
		tok := initI18n(t)
		rs, _ := valueFromResult[*ReferenceSet](BuildReferences(tok, []ClassifiedText{{Text: "Delete files", Domain: "technical"}}))
		got := rs.Compare(NewImprint(tok.Tokenise("Delete files")))
		if len(got) == 0 {
...
func TestReference_ReferenceSet_Classify_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("ReferenceSet_Classify Bad edge case")
		tok := initI18n(t)
		rs, _ := valueFromResult[*ReferenceSet](BuildReferences(tok, []ClassifiedText{{Text: "Delete files", Domain: "technical"}}))
		got := rs.Classify(NewImprint(tok.Tokenise("Delete files")))
		if got.Domain == "" {
...
func TestReference_ReferenceSet_Classify_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("ReferenceSet_Classify Ugly edge case")
		tok := initI18n(t)
		rs, _ := valueFromResult[*ReferenceSet](BuildReferences(tok, []ClassifiedText{{Text: "Delete files", Domain: "technical"}}))
		got := rs.Classify(NewImprint(tok.Tokenise("Delete files")))
		if got.Domain == "" {
...
func TestReference_ReferenceSet_DomainNames_Bad(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("ReferenceSet_DomainNames Bad edge case")
		tok := initI18n(t)
		rs, _ := valueFromResult[*ReferenceSet](BuildReferences(tok, []ClassifiedText{{Text: "Delete files", Domain: "technical"}}))
		got := rs.DomainNames()
		if len(got) == 0 {
...
func TestReference_ReferenceSet_DomainNames_Ugly(t *testing.T) {
	...
	noPanicForAudit(t, func() {
		called = true
		t.Log("ReferenceSet_DomainNames Ugly edge case")
		tok := initI18n(t)
		rs, _ := valueFromResult[*ReferenceSet](BuildReferences(tok, []ClassifiedText{{Text: "Delete files", Domain: "technical"}}))
		got := rs.DomainNames()
		if len(got) == 0 {
